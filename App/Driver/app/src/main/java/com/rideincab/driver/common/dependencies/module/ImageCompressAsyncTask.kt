    ...
    override fun doInBackground(vararg params: Void): Void? {
        try {
            ...
            if (file.exists()) {
                ...
                Log.i("DEEPAK_ERRROOR", "doInBackground: compressPath=$compressPath")
                Log.i("DEEPAK_ERRROOR", "doInBackground: docType=$docType")
                Log.i("DEEPAK_ERRROOR", "doInBackground: uploadType=$uploadType")
                Log.i("DEEPAK_ERRROOR", "doInBackground: expirydate=$expirydate")
