...
import com.rideincab.driver.common.helper.Constants.notificationIcon
...
class TrackingService : Service(){
    ...
    override fun onCreate() {
        ...
        mFirebaseDatabaseRequest = mFirebaseInstance.getReference(applicationContext.getString(com.rideincab.driver.R.string.real_time_db))
