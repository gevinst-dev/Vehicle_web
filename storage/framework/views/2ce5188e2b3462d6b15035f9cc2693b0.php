...
<body ng-app="App" class="<?php echo e((!isset($exception)) ? (Route::current()->uri() == '/' ? 'homepage' : '') : ''); ?> commonpage"><?php /**PATH C:\laragon\www\ridein25\resources\views/common/head.blade.php ENDPATH**/ ?>